...
export function enableServiceFeature() {
  ...
  setFeatureFlag(VSCODE_OPENAI_EMBEDDING.ENABLED_COMMAND_ID, false)
  if (SUPPORT_EMBEDDING.includes(SettingConfig.serviceProvider)) {
